...
public class Config {
	...
	public final static String REST_USERNAME = "restservicebasicauthuser";

	public final static String REST_PWD = "TL#2017@REST*832463$#";
	...
	public final static String EMAIL_KEY_WHENUSERNOTLOGINYET = "autogen3";
	
	public final static String EMAIL_SUBJECT_SOMETHINGWENTWRONG = "Something Went Wrong. Urgent Attention Needed";
	
	public final static String EMAIL_KEY_SOMETHINGWENTWRONG = "autogen5";
